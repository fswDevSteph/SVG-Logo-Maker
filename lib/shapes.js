...
class Square extends Shape {
  render() {
    ...
    return `<rect x="160" y="160" width="60" height="60" fill="${this.shapeColor}"/>`;
  }

  generateText() {
    // Calculate the center coordinates of the square
    const centerX = 160 + 30; // x-coordinate of the center of the square
    const centerY = 160 + 30; // y-coordinate of the center of the square
